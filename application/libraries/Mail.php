...
class Mail {
    ...
    public function sendsms($phone,$uname,$otp) {

$curl = curl_init();

curl_setopt_array($curl, array(
  CURLOPT_URL => "http://mobicomm.dove-sms.com//submitsms.jsp?user=Miracolo&key=63d06f365dXX&mobile=".$phone."&message=Dear ".$uname." Your OTP for login is ".$otp." Regards, Team Miracle Drinks.&senderid=MIRCOL&accusage=1&entityid=1701159256675943303&tempid=1707167592051531633",
