            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Treatment Add</h3>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Masters</a></li>
                            <li class="breadcrumb-item active">Treatment Add</li>
                        </ol>
                    </div>
                       ...
                       <div class="clearfix"></div>                           
                        <div class="col-md-6">
                                        <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="morning" name="morning"></textarea>
                                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                      <div class="form-group">
                                                        <label class="control-label">Afternoon</label>
                                                        <textarea class="form-control" id="afternoon" name="afternoon"></textarea>
                                                    </div>
                                 </div>
                                 <div class="clearfix"></div>    
                                  <div class="col-md-6">
                                      <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="evening" name="evening"></textarea>
                                                    </div>
                                 </div>
                                  <div class="col-md-6">
