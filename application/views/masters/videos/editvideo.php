                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                ...
                                                <?php 
                                                    ...
                                                    <input type="hidden" value="<?= $edit[0]->vid;?>" name="cid">
...
<div class="col-md-6">
            <div class="form-group">
                                                          <label class="control-label">Youtube Link<font style="color: red;">*</font></label>
                                                            <input type="url" id="url" name="url" class="form-control" value="<?= $edit[0]->video_id;?>"/>
            ...
            if(data.formerror ==false) {
              ...
              $("#processing").html('<div class="alert alert-danger alert-dismissible"><i class="fas fa-ban"></i> '+data.msg+'</div>').show();
               ...
               $("#processing").html('<div class="alert alert-success alert-dismissible"><i class="fas fa-circle-check"></i> '+data.msg+'</div>');
                setTimeout(function() {window.location.href="<?= base_url().'master/video';?>";}, 1000);
            }
          }
      });
  });
