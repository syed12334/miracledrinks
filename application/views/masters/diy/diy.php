...
<body class="padTop53 ">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
                        <div class="d-flex mt-2 justify-content-end">
                            <a href="<?= base_url() ?>master/adddiy" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD DIY</a>
                         </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
       /* $(document).ready(function() {
        ...
        $(function () {
            ...
            function changestatus(st, id) {
                ...
                if (confirm(msg)) {
                    $.ajax({
                        type: "POST",
                        url: base_url + "master/diy_status",
                        data: {
                            items: id,
                            status: st
                        },
        ...
        function edit(id) {
            var base_url = '<?php echo base_url(); ?>';
            document.location.href = base_url + "master/diy_edit?id=" + id;
        }
    </script>
</body>
<!-- END BODY-->
