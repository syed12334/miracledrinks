            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Articles Edit</h3>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Masters</a></li>
                            <li class="breadcrumb-item active">Articles Edit</li>
                        </ol>
                    </div>
                                            ...
                                            <div id="collapseOne" class="card-body">
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                    ...
                                                    <input type="hidden" value="<?= $edit[0]->art_id;?>" name="cid">
...
<div class="col-md-6">
               ...
               <!--        <div class="col-md-6">
                           <div class="form-group">
                                                        <label class="control-label">Short Description<font style="color: red;">*</font></label>
                                                        <textarea class="form-control" id="sdesc" name="sdesc"><?= $edit[0]->sdesc;?></textarea>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                                                        <label class="control-label">Long Description<font style="color: red;">*</font></label>
                                                        <textarea class="form-control" id="ldesc" name="ldesc"><?= $edit[0]->ldesc;?></textarea>
    ...
    e.preventDefault();
      ...
      $.ajax({
          url :"<?= base_url().'master/articlessave';?>",
          method :"post",
          dataType:"json",
          data :formdata,
          contentType: false,
            ...
            if(data.formerror ==false) {
              ...
              $("#processing").html('<div class="alert alert-danger alert-dismissible"><i class="fas fa-ban"></i> '+data.msg+'</div>').show();
               ...
               $("#processing").html('<div class="alert alert-success alert-dismissible"><i class="fas fa-circle-check"></i> '+data.msg+'</div>');
                setTimeout(function() {window.location.href="<?= base_url().'master/articles';?>";}, 1000);
            }
          }
      });
  });
