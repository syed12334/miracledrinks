            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Treatment Protocol Add</h3>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                            <li class="breadcrumb-item active">Treatment Protocol Add</li>
                        </ol>
                    </div>
                                                 ...
                                                 <div class="clearfix"></div>
                                                       ...
                                                       <div class="col-md-12">
                                                        ...
                                                        <div class="form-actions no-margin-bottom" style="text-align:center;">
                                                            ...
                                                            <a href="<?php echo base_url() . 'master/tprotocol'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save Changes</button>
                                                        </div>
                                                        </div>
 </div>
                                                </form>
