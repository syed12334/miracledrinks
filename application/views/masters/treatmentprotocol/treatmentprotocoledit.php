            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Treatment Protocol</h3>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                            <li class="breadcrumb-item active">Treatment Protocol</li>
                        </ol>
                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                ...
                                                <?php 
                                                    ...
                                                    <input type="hidden" value="<?= $edit[0]->id;?>" name="cid">
                                                    ...
                                                    <div class="form-group">
                                                          <label class="control-label">Image<font style="color: red;">*</font></label>
                                                            ...
                                                            <span id="image_error" class="text-danger"></span>
                                                             <?php 
                                                                if(!empty($edit[0]->thumbnail_image)) {
                                                                ?>
                                                                <img src="<?= base_url().$edit[0]->thumbnail_image; ?>" style="width: 90px">
                                                                <?php
                                                            }
                                                            ?>
                                                    </div>
...
<div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label">PDF File<font style="color: red;">*</font></label>
                                                            ...
                                                            <?php 
                                                                if(!empty($edit[0]->pdf)) {
                                                                ?>
                                                                <a href="<?= base_url().$edit[0]->pdf;?>">PDF Link</a>
                                                                <?php
                                                            }
                                                            ?>  
    ...
    e.preventDefault();
      ...
      $.ajax({
          url :"<?= base_url().'master/treatmentprotocolsave';?>",
          method :"post",
          dataType:"json",
          data :formdata,
          contentType: false,
            ...
            if(data.formerror ==false) {
              ...
              $("#processing").html('<div class="alert alert-danger alert-dismissible"><i class="fas fa-ban"></i> '+data.msg+'</div>').show();
               ...
               $("#processing").html('<div class="alert alert-success alert-dismissible"><i class="fas fa-circle-check"></i> '+data.msg+'</div>');
                setTimeout(function() {window.location.href="<?= base_url().'master/tprotocol';?>";}, 1000);
            }
          }
      });
  });
