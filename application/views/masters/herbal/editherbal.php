            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Herbal</h3>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Masters</a></li>
                            <li class="breadcrumb-item active">Herbal</li>
                        </ol>
                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                ...
                                                <?php 
                                                    ...
                                                    <input type="hidden" value="<?= $edit[0]->hid;?>" name="cid">
...
<div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">PDF File<font style="color: red;">*</font></label>
                                                            ...
                                                            <?php 
                                                                if(!empty($edit[0]->pdf_link)) {
                                                                ?>
                                                                <a href="<?= base_url().$edit[0]->pdf_link;?>">PDF Link</a>
                                                                <?php
                                                            }
                                                            ?>  
    ...
    e.preventDefault();
      ...
      $.ajax({
          url :"<?= base_url().'master/herbalsave';?>",
          method :"post",
          dataType:"json",
          data :formdata,
          contentType: false,
            ...
            if(data.formerror ==false) {
              ...
              $("#processing").html('<div class="alert alert-danger alert-dismissible"><i class="fas fa-ban"></i> '+data.msg+'</div>').show();
               ...
               $("#processing").html('<div class="alert alert-success alert-dismissible"><i class="fas fa-circle-check"></i> '+data.msg+'</div>');
                setTimeout(function() {window.location.href="<?= base_url().'master/herbal';?>";}, 1000);
            }
          }
      });
  });
