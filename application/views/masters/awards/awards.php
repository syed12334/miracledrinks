...
<body class="padTop53 ">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Awards</h3>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                            <li class="breadcrumb-item active">Awards & Certification</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
						<div class="d-flex mt-2 justify-content-end">
							<a href="<?= base_url() ?>master/addawards" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD Awards</a>
						 </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
       /* $(document).ready(function() {
		...
		$(function () {
			...
			function changestatus(st, id) {
				...
				if (confirm(msg)) {
					$.ajax({
						type: "POST",
						url: base_url + "master/awards_status",
						data: {
							items: id,
							status: st
						},
        ...
        function edit(id) {
            var base_url = '<?php echo base_url(); ?>';
            document.location.href = base_url + "master/awards_edit?id=" + id;
        }
    </script>
</body>
<!-- END BODY-->
