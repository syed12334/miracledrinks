                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                ...
                                                <?php 
                                                    ...
                                                    <input type="hidden" value="<?= $edit[0]->aid;?>" name="cid">
...
<div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Image<font style="color: red;">*</font></label>
                                                            ...
                                                            <?php 
                                                                ...
                                                                ?>
                                                                <a src="<?= base_url().$edit[0]->image;?>" style="width:100px">
                                                                <?php
                                                            }
                                                            ?>  
    ...
    e.preventDefault();
      ...
      $.ajax({
          url :"<?= base_url().'master/awardssave';?>",
          method :"post",
          dataType:"json",
          data :formdata,
          contentType: false,
            ...
            if(data.formerror ==false) {
              ...
              $("#processing").html('<div class="alert alert-danger alert-dismissible"><i class="fas fa-ban"></i> '+data.msg+'</div>').show();
               ...
               $("#processing").html('<div class="alert alert-success alert-dismissible"><i class="fas fa-circle-check"></i> '+data.msg+'</div>');
                setTimeout(function() {window.location.href="<?= base_url().'master/awards';?>";}, 1000);
            }
          }
      });
  });
