                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
						 <div class="d-flex mt-2 justify-content-end">
							<a href="<?= base_url() ?>master/city_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD City</a>
                    </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
       ...
       var dataTable;
            function initialiseData(){
                dataTable = $('#getCity').DataTable({  
                    "processing":true,  
                    "serverSide":true,  
                    "searching": true,
                    "order":[],  
                    "ajax":{  
                        url:"<?php echo base_url('master/cityList/'); ?>",  
                        type:"POST",
...
initialiseData();
		...
		function changestatus(st, id) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "master/city_status",
                    data: {
                        items: id,
                        status: st
                    },
