            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">States</h3>
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
						 <div class="d-flex mt-2 justify-content-end">
							<a href="<?= base_url() ?>master/states_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD State</a>&nbsp;&nbsp;
                    </div>
                    </div>
                </div>
       ...
       var dataTable;
            function initialiseData(){
                dataTable = $('#getStates').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?php echo base_url('master/statesList/'); ?>",  
                        type:"POST",
...
initialiseData();
		...
		function changestatus(st, id) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "master/states_status",
                    data: {
                        items: id,
                        status: st
                    },
