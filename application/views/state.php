...
<body class="padTop53 ">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
						...
						<a href="<?= base_url() ?>others/state_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD State</a>
						</div>
						<div class="d-flex mt-2 justify-content-end">
						<a href="<?= base_url() ?>others/state_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD State</a>
						</div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#flex1").flexigrid({
                url: base_url + 'others/state_table',
                dataType: 'json',
                colModel: [{
                        display: 'Sl No.',
                        width: 70,
        ...
        function test(com, grid) {
            if (com == 'Add') {
                var base_url = '<?php echo base_url(); ?>';
                document.location.href = base_url + "others/state_add";
            } else if (com == 'Refresh') {
                sortAlpha("");
            }
		...
		function changestatus(st, id) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "others/state_status",
                    data: {
                        items: id,
                        status: st
                    },
        ...
        function edit(id) {
            var base_url = '<?php echo base_url(); ?>';
            document.location.href = base_url + "others/state_edit?id=" + id;
        }
    </script>
</body>
<!-- END BODY-->
