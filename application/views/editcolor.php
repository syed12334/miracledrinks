            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Color</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/color_edit'; ?>" class="form-horizontal form-material" id="brand-validate" method="post">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-actions no-margin-bottom" style="text-align:center;">
                                                                <a href="<?php echo base_url() . 'master/color'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info "><i class="mdi mdi-check "></i> Save Changes</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/color_save'; ?>" class="form-horizontal form-material" id="brand-validate" method="post">
                                                        ...
                                                        <table class="table table-bordered ">
                                                            ...
                                                            <tbody id="p">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>Color Name<font style="color: red;">*</font>
                                                                    </th>
                                                                    <th width="200" class="text-center"><span id="newr" onClick="addmore();" class="btn btn-info text-center"><i class="fas fa-plus"></i></span></th>
                                                                </tr>
                                                    ...
                                                    <div class="form-actions" style="text-align:center;">
                                                        <a href="<?php echo base_url() . 'master/color'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info "><i class="mdi mdi-check "></i> Save</button>
                                                    </div>
