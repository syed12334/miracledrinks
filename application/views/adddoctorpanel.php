            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Add Treatment</h3>
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/symptoms_edit'; ?>" class="form-horizontal form-material" enctype="multipart/form-data" id="brand-validate" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label">Patience<font style="color: red;">*</font></label>
                                                         <select name="users" id="users" class="form-control" required>
                                                             <option value="">Select Patience</option>
                                                             <?php
                                                                if(count($users) >0) {
                                ...
                                <?php } else { ?>
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/treatmentadd_save'; ?>" class="form-horizontal form-material" method="post">
                                                         ...
                                                         <select name="users" id="users" class="form-control" required>
                                                             ...
                                                             <?php
                                                                if(count($users) >0) {
                                                                    foreach ($users as $key => $value) {
                                                                        ?>
                                                                        <option value="<?= $value->id;?>"><?php if(!empty($value->name)) {echo $value->name .' -';} echo $value->phone;?></option>
                                                                        <?php
                                                                    }
                                                                }
                                                             ?>
                                                    ...
                                                    <div class="col-md-6">
                                                       ...
                                                       <div class="col-md-12">
                                                        ...
                                                        <div class="form-actions no-margin-bottom" style="text-align:center;">
                                                            ...
                                                            <a href="<?php echo base_url() . 'master/symptoms'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Start Treatment</button>
                                                        </div>
                                                        </div>
 </div>
                                                </form>
