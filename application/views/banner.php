...
<body class="padTop53 ">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 col-12 align-self-center d-none d-md-block">
					<div class="d-flex mt-2 justify-content-end">
							<a href="<?= base_url() ?>homepage/banner_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD Banner</a>
						 </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
      /*  $(document).ready(function() {
            ...
            $("#flex1").flexigrid({
                url: base_url + 'homepage/banner_table',
                dataType: 'json',
                colModel: [{
                        display: 'Sl No.',
                        name: 'id',
        ...
        function test(com, grid) {
            if (com == 'Add') {
                var base_url = '<?php echo base_url(); ?>';
                document.location.href = base_url + "homepage/banner_add";
            } else if (com == 'Refresh') {
                sortAlpha("");
            }
		...
		function changestatus(st, id) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "homepage/banner_status",
                    data: {
                        items: id,
                        status: st
                    },
        ...
        function edit(id) {
            var base_url = '<?php echo base_url(); ?>';
            document.location.href = base_url + "homepage/banner_edit?id=" + id;
        }
    </script>
</body>
<!-- END BODY-->
