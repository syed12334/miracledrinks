            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Sub Sub Category</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Edit Sub Sub Category</h5>
                                                 

                                            </div>
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/sub_subcategory_edit'; ?>" class="form-horizontal form-material" enctype="multipart/form-data" id="brand-validate" method="post">
                                                    ...
                                                    <div class="col-md-6">
																	...
																	<?php if(is_array($country)){
																		...
																		?>
																			<option value="<?php echo $d->id?>"  <?php
                                                                                if($details[0]->subcategory_id == $d->id) {
                                                                                    echo "selected";
                                                                                }
                                                        ...
                                                        <div class="form-actions" style="text-align:center;">
                                                            ...
                                                            <a href="<?php echo base_url() . 'master/sub_subcategory'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info "><i class="mdi mdi-check "></i> Save Changes</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </form>
                                ...
                                <?php } else { ?>
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/sub_subcategory_save'; ?>" class="form-horizontal form-material" enctype="multipart/form-data" id="brand-validate" method="post">
