<?php //echo "<pre>";print_r($size);exit; 
?>
<!DOCTYPE html>
				...
				<div class="container-fluid" id="content">
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<form   class="form-horizontal form-material row formSubmit" id="organization_validate"  method="post" enctype="multipart/form-data">
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<?php
												...
												<input class="form-check-input material-inputs" name="package<?php echo $pack->id; ?>" type="checkbox" id="inlineCheckbox<?php echo $pack->id; ?>" value="<?php echo $pack->id; ?>" >
...
<div class="col-6">
														...
														<input type="url" name="youtube1" id="youtube" class="form-control" placeholder="Enter Youtube Url" >
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse" name="howtouse1"></textarea>
														</div>
													</div>
													...
													<div class="row">
														<div class="col-6">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="sname1" name="snames" />
															</div>
														</div>
														<div class="col-6">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="svalue1" name="svalues" />
															</div>
														</div>
													</div>
											</div>
										...
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
											...
											<div class="card-body">
												<div class=" row">
													<div class="form-group col-md-3">
														<label>Product Code<span style="color:red">*</span></label>
														<input type="text" class="form-control" name="pcode1" id="pcode1" />
														<div id="pcodeError"></div>
													</div>
													<div class="form-group col-md-3">
														<label>MRP<span style="color:red">*</span></label>
														<input type="number" class="form-control" name="mrp1" id="mrp1" />
														<div id="mrpError"></div>
													</div>
													<div class="form-group col-md-3">
														<label>Selling price<span style="color:red">*</span></label>
														<input type="number" class="form-control" name="sellingprice1" id="sellingprice1" />
														<div id="sellingError"></div>
													</div>
													<div class="form-group col-md-3">
														<label>Stock<span style="color:red">*</span></label>
											...
											<div class="col-6">
														...
														<input type="url" name="youtube2" id="youtube" class="form-control" placeholder="Enter Youtube Url" >
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse" name="howtouse2"></textarea>
														</div>
													</div>
...
<div class="col-12">
								...
								<div class="col-6">
												<div class="form-group">
													...
													<select name="sizes2" id="sizes2" class="form-control">
														<option value="">Select Size</option>
														<?php 
															if(count($size)) {
																foreach ($size as $key => $value) {
...
<div class="col-6">
														...
														<input type="url" name="youtube3" id="youtube" class="form-control" placeholder="Enter Youtube Url" >
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse" name="howtouse3"></textarea>
														</div>
													</div>
									...
									<div class="card  col-lg-12">
										...
										<div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
											...
											<div class="col-6">
														...
														<input type="url" name="youtube4" id="youtube" class="form-control" placeholder="Enter Youtube Url" >
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse" name="howtouse4"></textarea>
														</div>
													</div>
												...
												<div class="">
													<table class="table table-bordered ">
														...
														<tbody id="l">
															...
															<tr>
																<td><input type="text" name="orderno3[]" id="orderno3" class="form-control onlynumbers" placeholder="Order No" value="1" /></td>
																<td>
																	<div class="fileupload fileupload-new" data-provides="fileupload">
																		<div class="fileupload-preview thumbnail" style="width: 150px; height: 150px;">
																		</div>
																...
																<td>
																	<div class="fileupload fileupload-new" data-provides="fileupload">
																		...
																		<div>
																			<span class="btn btn-file btn-info"><span class="fileupload-new">Select
																					image</span><span class="fileupload-exists">Change</span>
																				<input type="file" name="galmedium3[]" id="galmedium3" /></span>
																			<a href="#" class="btn btn-primary fileupload-exists" data-dismiss="fileupload">Remove</a>
																			<input type="hidden" id="gimgstat" name="gimgstat" value="0">
																		</div>
																	</div>
																...
																<td>
																	<div class="fileupload fileupload-new" data-provides="fileupload">
																		...
																		<div>
																			<span class="btn btn-file btn-info"><span class="fileupload-new">Select
																					image</span><span class="fileupload-exists">Change</span>
																				<input type="file" name="gallarge3[]" id="gallarge3" /></span>
																			<a href="#" class="btn btn-primary fileupload-exists" data-dismiss="fileupload">Remove</a>
																			<input type="hidden" id="gimgstat" name="gimgstat2" value="0">
																		</div>
																	</div>
...
<td class="mininwidth text-center">
														...
														<div class="col-6">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="sname3" name="sname3" />
															</div>
														</div>
														<div class="col-6">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="svalue3" name="svalue3" />
															</div>
														</div>
													</div>
												</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			messages: {
				...
				galthumbs:"Select thumbnail image",
				galmedius:"Select medium image",
				galsmalls:"Select small image",
				gallarges:"Select large image",
				galthumb1:"Select thumbnail image",
				galsmall1:"Select small image",
				galmedium1:"Select medium image",
				gallarge1:"Select large image",
				galthumb2:"Select thumb image",
				galsmall2:"Select small image",
				galmedium2:"Select medium image",
				gallarge2:"Select large image",
				galthumb3:"Select thumb image",
				galsmall3:"Select small image",
				galmedium3:"Select medium image",
				gallarge3:"Select large image",
		...
		$(document).ready(function() {
			$("#organization_validate").on('submit',function(e) {
				...
				if($none_checked && $none == '7'){
					...
					var galthumbs = $("#galthumbs").val();
					var formdata = new FormData(this);
					var  package1 = $("#inlineCheckbox7").val();
					var galthumbs = $("#galthumbs").val();
					var galsmalls = $("#galsmalls").val();
					var galmedius = $("#galmedius").val();
					var gallarges = $("#gallarges").val();
					...
					$.ajax({
					url :"<?= base_url().'master/newProductsave';?>",
					method :"post",
					contentType:false,
					processData:false,
					data :formdata,
