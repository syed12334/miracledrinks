            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Brochure</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'about/brochure_save'; ?>" class="form-horizontal" id="form" method="post" enctype="multipart/form-data">
											<div class="form-group">
												<label class="control-label col-lg-2">Brochure <font style="color: red;">*</font></label>
												<div class="col-lg-8">
													<input type="file" id="brochure_pdf" name="brochure_pdf" class="form-control" value="<?php echo front_url().$info[0]->brochure_pdf ?>" required />
													<?php if($info[0]->brochure_pdf!=''){?><a href="<?php echo front_url().$info[0]->brochure_pdf ?>" target="_blank">View</a><?php }?>
												</div>
											</div>
