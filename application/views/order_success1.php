               ...
               <tr>
                  <td align="center" width="100%">
                     <div class="sortable_inner">
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="100%">
                           <tr>
                              <td align="center" height="151" valign="middle" width="100%"><img alt="logo" height="151" src="<?php echo asset_url(); ?>images/logo.png" style="height:151px;"></td>
                           </tr>
                        </table>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                           <tr>
                                 ...
                                 <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="100%">
                                    <tr>
                                       <td align="center" valign="middle" width="100%">
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" class="fullCenter" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="100%">
                                             <tr>
                                                <td style="font-size:16px; color:#000000; padding:0 15px; text-align: left; font-family:'Lato',Arial, sans-serif; font-weight:400; line-height:26px;" width="50%">Order Id : <?php echo $order['orderid'];?></td> 
                                                <td style="font-size:16px; color:#000000; padding:0 15px; text-align: right; font-family:'Lato',Arial, sans-serif; font-weight:400; line-height:26px;" width="50%">Placed On : <?php $date=date_create($order['ordered_date']);echo date_format($date,"d-m-Y");?></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                                 ...
                                 <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="570">
                                   ...
                                   <?php if(is_array($order_products)){
                                       ...
                                       <td align="center" bgcolor="#FAFAFA" class="em_pad" valign="top">
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="500">
                                             <tr>
                                                ...
                                                <td align="left" style="font-size:13px; color:#aaaaaa; font-family:'Lato',Arial, sans-serif; font-weight:400;" valign="middle" width="63%"><span style="font-size:15px; color:#36628b; font-family:'Lato',Arial, sans-serif; font-weight:700;"><?php echo $ord['pname']?></span><br>
                                                <?php echo $ord['sname'];?></td>
                                                <td align="left" style="font-size:13px; color:#36628b; font-family:'Lato',Arial, sans-serif; font-weight:400;" width="25%">Price<br>
                                                <span style="font-size:15px; color:#000; font-family:'Lato',Arial, sans-serif; font-weight:700;">Rs.<?php echo $this->home_db->getnumberformat($ord['unit_price']);?></span></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                                    ...
                                    <tr>
                                     ...
                                     <?php
                                if(!empty($order['taxamount']) && $order['taxamount'] !=0) {
                                    ?>
                                    <tr>
                                       <td align="center" bgcolor="#FAFAFA" class="em_pad" valign="top">
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="500">
                                             <tr>
                                                <td align="left" colspan="3" style="font-size:13px; text-align: right; color:#36628b; font-family:'Lato',Arial, sans-serif; font-weight:400;" width="25%">Tax <span style="font-size:15px; color:#000; font-family:'Lato',Arial, sans-serif; font-weight:700;">Rs.<?php echo number_format($order['taxamount']);?></span></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                                ...
                                ?>
                                    ...
                                    <tr>
                                       <td align="center" bgcolor="#FAFAFA" class="em_pad" valign="top">
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="500">
                                             <tr>
                                                <td align="left" colspan="3" style="font-size:13px; text-align: right; color:#36628b; font-family:'Lato',Arial, sans-serif; font-weight:400;" width="25%">Delivery Charges <span style="font-size:15px; color:#000; font-family:'Lato',Arial, sans-serif; font-weight:700;">Rs.<?php echo $this->home_db->getnumberformat($order['devilery_charge']);?></span></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                                    ...
                                    <tr>
                                       <td align="center" bgcolor="#FAFAFA" class="em_pad" valign="top">
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="500">
                                             <tr>
                                                <td align="left" colspan="3" style="font-size:13px; text-align: right; color:#36628b; font-family:'Lato',Arial, sans-serif; font-weight:400;" width="25%">Total Amount <span style="font-size:15px; color:#000; font-family:'Lato',Arial, sans-serif; font-weight:700;">Rs.<?php echo $this->home_db->getnumberformat($order['total_amt_paid']);?></span></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                                 ...
                                 <table align="left" border="0" cellpadding="0" cellspacing="0" style="font-size:13px; font-family:'Lato',Arial, sans-serif;" width="65%">
                                    ...
                                    <tr>
                                       <td style="padding:0 15px;">+91 <?php echo $call?><br>
                                       <?= $emlid;?></td>
                                    </tr>
                                 </table>
                        ...
                        <tr>
                           <td>
                              <div class="sortable_inner">
                                 <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                       <td align="center" style="font-family:'Lato', Arial, sans-serif; font-weight:400; font-size:11px; color:#aaaaaa; line-height:22px;" valign="top">©Copyright 2022 Gogarbha. All Rights Reserved.</td>
                                    </tr>
                                 </table>
                                 <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
