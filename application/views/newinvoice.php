...
<style>
 ...
 <table style="width:100%; font-family: 'Noto Serif', serif; font-size:14px; border-bottom:1px solid #000;" cellpadding="0" cellspacing="0">
  <thead>
      ...
      <img src="<?php echo front_url(); ?>assets/images/logo_12.png" style="width:100px; display: inline-block;"/>  
           
      </td>
      
      <td  align="left" valign="top" style="padding: 1px;">
       <p style="margin-bottom:5px"><b>Sold By: </b> Dhrtva </p>
            
       <p style="margin-bottom:5px"><b>Phone : </b> +91 99005 99005</p>
       <p style="margin-bottom:5px"><b>Email : </b> support@dhrtva.com</p>
      </td>
  ...
  <tr>
    <td width="50%" align="left" valign="top">
           ...
           <p>
                            ...
                            <b>Invoice Date : </b><?php echo date('d/m/Y h:i:s A',strtotime($order[0]->invoice_date));?> 
                        </p>
                      </td>
                    </tr>
</table>
...
?>
		...
		<table style="width:100%; margin:30px 0; border-top:1px solid #333; font-size:14px;" width="0" border="0" cellpadding="0" cellspacing="0"> 
             ...
             <td valign="top" style="padding:7px; border-bottom:1px solid #333; border-left:1px solid #333; border-right:1px solid #333;" 
               ...
               <td colspan="6" valign="top" style="padding:7px; border-bottom:1px solid #333; border-left:1px solid #333;" align="left"><strong>Delivery Charges: </strong></td>
             ...
             <tr>
               ...
               <td colspan="5" valign="top" style="padding:7px; border-bottom:1px solid #333; border-left:1px solid #333;" align="left"><strong> TOTAL: </strong></td>
               ...
               <td valign="top" style="padding:7px; border-bottom:1px solid #333; background-color: #ccc; border-right:1px solid #333; border-left:1px solid #333;" align="left"><strong>
                <h3 style="font-size:16px; font-style:normal; margin:0px 22px 0px 0;">
               <?php echo $price_icon;?> <?php echo array_sum($newAr)+$orders[0]->devilery_charge;
                ?></h3>  </strong> </td>
             ...
             <tr>              
               ...
               <td colspan="7" valign="top" style="padding:3px; font-size:16px; border-bottom:1px solid #333; border-right:1px solid #333; border-left:1px solid #333;" 
             ...
             <tr>              
               ...
               <td colspan="7" valign="top" style="padding:2px; font-size:15px;" 
