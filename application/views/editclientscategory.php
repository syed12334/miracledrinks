...
<body class="padTop53 ">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Client Categories</h3>
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Edit Client Category</h5>
                                        </div>
                                        <div id="collapseOne" class="card-body">
                                            <form action="<?php echo base_url() . 'homepage/clientscategory_edit'; ?>" class="form-horizontal form-material row" id="brand-validate" method="post">


                                                <div class="form-group col-md-6">
                                                    <label class="control-label">Order<font style="color: red;">*</font></label>
                                                    <input type="text" value="<?php echo $details[0]->order_no; ?>" id="order" name="order" class="form-control onlynumbers" placeholder="" required="required" />
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label class="control-label">Client Category Name<font style="color: red;">*</font></label>
                                                ...
                                                <div class="form-actions no-margin-bottom  col-md-12" style="text-align:center;">
                                                    <a href="<?php echo base_url() . 'homepage/clientscategory'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save Changes</button>
                                                </div>
                            ...
                            <?php else : ?>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Add Client Category</h5>
                                        </div>
                                        <div id="collapseOne" class="card-body">
                                            <form action="<?php echo base_url() . 'homepage/clientscategory_save'; ?>" class="form-horizontal form-material row" id="brand-validate" method="post">
                                                ...
                                                <div class="form-group col-md-12">
                                                        <table class="table table-bordered ">
                                                            ...
                                                            <tbody id="p">
                                                                <tr>
                                                                    <th width="100"><label>Order No<font style="color: red;">*</font></label></th>
                                                                    <th><label>Client Category Name<font style="color: red;">*</font></label></th>
                                                                    <th width="200" class="text-center"><label>Add/Remove</label></th>
                                                                </tr>
                                                                <tr>
                                                                    <td><input type="text" id="order" name="order[]" class="form-control onlynumbers" required="required" /></td>
                                                                    <td><input required type="text" name="np[]" class="form-control" placeholder="" /></td>
                                                                    <td class="mininwidth text-center"><span id="newr" onClick="addmore();" class="btn btn-info"><i class="fas fa-plus"></i></span></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                </div>
                                                ...
                                                <div class="form-actions no-margin-bottom col-md-12" style="text-align:center;">
                                                    <a href="<?php echo base_url() . 'homepage/clientscategory'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save</button>
                                                </div>
    ...
    <script>
        ...
        function addmore() {
            ...
            var row = "<tr id='r_" + x + "'><td><input type='text' id='order' name='order[]' class='form-control onlynumbers' required='required'/></td><td><input type='text' name='np[]' class='form-control' required placeholder=''/></td><td class='text-center'><span class='btn btn-primary' onclick='remove123(" + x + ")'><i class='fas fa-minus'></i></span></td></tr>";
            $('#p').append(row);
        }
