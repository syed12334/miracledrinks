...
<input type="hidden" name="pid" value="<?= $products[0]->id?>">
									...
									<div class="form-group col-md-4">
										<label>TAX</label>
										<input type="number" class="form-control" name="tax" id="tax" value="<?= $products[0]->tax?>"/>
										...
										<div class="row" style="padding:15px">
											...
											<div class="col-6">
												<div class="form-group">
													...
													<textarea class="form-control" name="overviews ckeditor" id="overviews"><?= $productpackagenone[0]->overview?></textarea>
												</div>
											...
											<div class="col-6">
												<div class="form-group">
													...
													<textarea class="form-control ckeditor" id="mtdess" name="mtdess"><?= $productpackagenone[0]->mdesc?></textarea>
												</div>
											</div>
											...
											<div class="col-6">
														...
														<input type="url" name="youtube1" id="youtube" class="form-control" placeholder="Enter Youtube Url" value="<?= $productpackagenone[0]->youtube;?>">
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse1" name="howtouse1"><?= $productpackagenone[0]->how_to_use;?></textarea>
														</div>
													</div>

											<div class="col-6">
												<div class="form-group">
													<label class="control-label">Select size
														...
														<?php 
															if(count($size)) {
																foreach ($size as $key => $value) {
																	?>
																	<option value="<?= $value->id;?>" <?php if( $value->id ==$productpackagenone[0]->psize) {echo "selected";}?>><?= $value->name;?></option>
																	<?php
																}
															}
														?>
												...
												<table class="table table-bordered ">
													...
													<tbody id="i">
														...
														<td class="mininwidth text-center">
																				<span id="newr" class="btn btn-warning" onclick="return pidelete('<?= $img->piid;?>')" style="background:red!important;color:#fff"><i class="fas fa-minus" ></i></span>
																			</td>
									...
									?>
										...
										<div class="row" style="padding:15px">
											...
											<div class="col-6">
												<div class="form-group">
													<label class="control-label">Overview<span style="color:red">*</span></label>
													<textarea class="form-control ckeditor" name="overviews " id="overviews "></textarea>
												</div>
												<div id="overviewError"></div>
											</div>
											...
											<div class="col-6">
												<div class="form-group">
													...
													<textarea class="form-control ckeditor" id="mtdess" name="mtdess"></textarea>
												</div>
											</div>
	...
	<div class="col-6">
														...
														<input type="url" name="youtube1" id="youtube" class="form-control" placeholder="Enter Youtube Url" value="">
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse1" name="howtouse1"></textarea>
														</div>
													</div>
												<div class="col-6">
												<div class="form-group">
											...
											<div class="card-body">
												<div class=" row">
													...
													<div class="col-6">
														<div class="form-group">
															<label class="control-label">Overview<span style="color:red">*</span></label>
															<textarea class="form-control ckeditor" id="overview1 " name="overview1"><?= $productpackagegold[0]->overview; ?></textarea>
														</div>
														<div id="overviewError"></div>
													</div>
													<div class="col-6">
														<div class="form-group">
															...
															<textarea class="form-control ckeditor" id="mtdesc1" name="mtdesc1"><?= $productpackagegold[0]->mdesc; ?></textarea>
														</div>
													</div>
														...
														<input type="url" name="youtube2" id="youtube" class="form-control" placeholder="Enter Youtube Url" value="<?= $productpackagegold[0]->youtube;?>">
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse2" name="howtouse2"><?= $productpackagegold[0]->how_to_use;?></textarea>
														</div>
													</div>
														<div class="col-6">
												<div class="form-group">
													...
													<select name="sizes1" id="sizes" class="form-control">
														<option value="">Select Size</option>
														<?php 
															if(count($size)) {
																foreach ($size as $key => $value) {
																	?>
																	<option value="<?= $value->id;?>" <?php if( $value->id ==$productpackagegold[0]->psize) {echo "selected";}?>><?= $value->name;?></option>
																	<?php
																}
															}
														?>
												...
												<div class="">
													<table class="table table-bordered ">
														...
														<th width="100px">Order No</th>
															...
															<th><span id="newr" onClick="addmoregold();" class="btn btn-info"><i class="fas fa-plus"></i></span></th>
											...
											<div class="card-body">
												<div class=" row">
													...
													<div class="col-6">
														...
														<input type="url" name="youtube2" id="youtube" class="form-control" placeholder="Enter Youtube Url" value="">
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse2" name="howtouse2"></textarea>
														</div>
													</div>
														<div class="col-6">
												<div class="form-group">
											...
											<div class=" row">
													...
													<div class="col-6">
														<div class="form-group">
															...
															<textarea class="form-control ckeditor" id="overview2 " name="overview2"><?= $productpackagesilver[0]->overview;?></textarea>
														</div>
														<div id="overviewError"></div>
													</div>
													<div class="col-6">
														<div class="form-group">
															...
															<textarea class="form-control ckeditor" id="mtdesc2 " name="mtdesc2"><?= $productpackagesilver[0]->mdesc;?></textarea>
														</div>
													</div>
													...
													<div class="col-6">
														...
														<input type="url" name="youtube3" id="youtube" class="form-control" placeholder="Enter Youtube Url" value="<?= $productpackagesilver[0]->youtube;?>">
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse3" name="howtouse3"><?= $productpackagesilver[0]->how_to_use;?></textarea>
														</div>
													</div>
												...
												<div class="form-group">
													...
													<select name="sizes2" id="sizes" class="form-control">
														<option value="">Select Size</option>
														<?php 
															if(count($size)) {
																foreach ($size as $key => $value) {
																	?>
																	<option value="<?= $value->id;?>" <?php if( $value->id ==$productpackagesilver[0]->psize) {echo "selected";}?>><?= $value->name;?></option>
																	<?php
																}
															}
														?>
												...
												<div class="">
													<table class="table table-bordered ">
														...
														<th width="100px">Order No</th>
															...
															<th><span id="newr" onClick="addmoresilver();" class="btn btn-info"><i class="fas fa-plus"></i></span></th>
								...
								?>
											...
											<div class=" row">
													...
													<div class="col-6">
														...
														<input type="url" name="youtube3" id="youtube" class="form-control" placeholder="Enter Youtube Url" value="">
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse3" name="howtouse3"></textarea>
														</div>
													</div>
														<div class="col-6">
												<div class="form-group">
										...
										<div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion" style="<?php if(in_array(3, $ars)) {echo 'display:block';}else {echo 'display:none';}?>">
											...
											<div class=" row">
													...
													<div class="col-6">
														<div class="form-group">
															<label class="control-label">Overview<span style="color:red">*</span></label>
															<textarea class="form-control ckeditor" id="overview3 " name="overview3"><?= $productpackagenormal[0]->overview;?></textarea>
														</div>
														<div id="overviewError"></div>
													</div>
													<div class="col-6">
														<div class="form-group">
															...
															<textarea class="form-control ckeditor" id="mtdesc3 " name="mtdesc3"><?= $productpackagenormal[0]->mdesc;?></textarea>
														</div>
													</div>
													...
													<div class="col-6">
														...
														<input type="url" name="youtube4" id="youtube" class="form-control" placeholder="Enter Youtube Url" value="<?= $productpackagenormal[0]->youtube;?>">
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse4" name="howtouse4"><?= $productpackagenormal[0]->how_to_use;?></textarea>
														</div>
													</div>
														<div class="col-6">
												<div class="form-group">
													...
													<select name="sizes3" id="sizes" class="form-control">
														<option value="">Select Size</option>
														<?php 
															if(count($size)) {
																foreach ($size as $key => $value) {
																	?>
																	<option value="<?= $value->id;?>" <?php if( $value->id ==$productpackagenormal[0]->psize) {echo "selected";}?>><?= $value->name;?></option>
																	<?php
																}
															}
														?>
												...
												<div class="">
													<table class="table table-bordered ">
														...
														<th width="100px">Order No</th>
															...
															<th><span id="newr" onClick="addmorenormal();" class="btn btn-info"><i class="fas fa-plus"></i></span></th>
		...
		<div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
											...
											<div class=" row">
													...
													<div class="col-6">
														<div class="form-group">
															<label class="control-label">Overview<span style="color:red">*</span></label>
															<textarea class="form-control ckeditor" id="overview3" name="overview3"></textarea>
														</div>
														<div id="overviewError"></div>
													</div>
													<div class="col-6">
														<div class="form-group">
															...
															<textarea class="form-control ckeditor" id="mtdesc3 " name="mtdesc3"></textarea>
														</div>
													</div>
													...
													<div class="col-6">
														...
														<input type="url" name="youtube4" id="youtube" class="form-control" placeholder="Enter Youtube Url" value="">
														</div>
													</div>
														...
														<div class="form-group">
															...
															<textarea class="form-control" id="howtouse4" name="howtouse4"></textarea>
														</div>
													</div>
														<div class="col-6">
												<div class="form-group">
...
<script type="text/javascript">
	 ...
	 CKEDITOR.replace('overview2');
	 CKEDITOR.replace('overview3');
	 /*CKEDITOR.replace('overviews');*/
	 CKEDITOR.replace('mtdess');
	 CKEDITOR.replace('mtdesc1');
	 CKEDITOR.replace('mtdesc2');
	 CKEDITOR.replace('mtdesc3');
	 CKEDITOR.replace('howtouse1');
	 CKEDITOR.replace('howtouse2');
	 CKEDITOR.replace('howtouse3');
	 CKEDITOR.replace('howtouse4');
    ...
    height: 300,
		...
		$(document).ready(function() {
			$("#organization_validate").on('submit',function(e) {
				...
				if($none_checked && $none == '7'){
					...
					$.ajax({
					url :"<?= base_url().'master/updateProductPackage';?>",
					method :"post",
					contentType:false,
					processData:false,
					data :formdata,
	 ...
	 <script src="https://cdn.tiny.cloud/1/a6tj60xi1k10z1c7trmg4bk6mp3dzpe9eoyi37anyzfpllhc/tinymce/5/tinymce.min.js"></script> 
	<script>
			

		function pidelete(id) {
			$.ajax({
				url :"<?= base_url().'master/productimagesd'; ?>",
				method:"post",
				data: {
					piid:id
				},
