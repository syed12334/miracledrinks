				...
				<div class="inner" style="min-height:1200px;">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<form action="<?php echo base_url() . 'homepage/gift_save'; ?>" class="form-group form-material" id="organization_validate" method="post" enctype="multipart/form-data">
								<div class="alert alert-info alert-dismissable"><strong>Note:</strong> Please add image
									of size 91 x 93 px</div>

								<div class="row" id="vasediv">
									<div class="form-group col-md-4" style="display:none;">
										<label class="control-label">Order No. <font style="color: red;">*
											</font></label>
									...
									<div class="form-group col-md-4" style="display:none;">
										<label class="control-label">Offer Title <font style="color: red;">*
											</font></label>

										<input type="text" id="name" name="name" class="form-control" required maxlength="35" value="" />

									</div>


									<div class="form-group col-md-4">
										<label class="control-label">Image <font style="color: red;">*</font>
										</label>
										<div class="col-md-8">
									...
									<div class="col-md-5">
											...
											<div class="input-group">
												...
												<select id="demo" class="form-control" onchange="change(this.value);">
													<?php
													if (is_array($cat)) {
										...
										<font style="color: red;"> <label style="visibility: hidden;" id="nf">Product
												Not Found</label></font>
										<div class="form-group">

											<select id="box1View" style="height:400px " multiple="multiple" class="form-control" size="16">
									...
									<div class="col-md-5">
										...
										<div class="form-group">
											<select id="box2View" style="height: 400px" name="proname[]" multiple="multiple" class="form-control" size="16"></select>
										</div>
					...
					<div class="form-actions" style="text-align:center;">
						<a href="<?php echo base_url() . 'homepage/gifts'; ?>" class="btn btn-primary"><i class="mdi mdi-close"></i> Cancel</a>&nbsp;&nbsp;&nbsp; <button type="button" class="btn btn-info" id="validate"><i class="mdi mdi-check "></i> Save</button>
					</div>
</div>
				</div>
			</div>
	...
	<script>
		function check_vase() {
			...
			if (document.getElementById("imag").value == "") {
				$("#msgbox3").html(
					"<div class='alert alert-warning alert-danger' id='msgbox3' style='opacity: 1;'><button type='button' class='close' data-dismiss='alert'>&times;</button>Upload Image</div>"
				).addClass('alert-danger').fadeTo(900, 1);
				return false;
			}
