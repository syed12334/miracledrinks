<?php 
		...
		$data.='<div id="cart-tab" class="tab selected" style="width: 100%;">Download Incentive ';
		...
		$data.='<td><a href="'.front_url().$row[0]->invoice_pdf.'" class="btn btn-primary btn-xs" target="_blank"> Download Incentive</button></td>';
		$data.='</tr>';				 
