                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
                         <div class="d-flex mt-2 justify-content-end">
                            <a href="<?= base_url() ?>master/adddoctorpanel" class="btn btn-info"><i class="mdi mdi-plus"></i> Add Treatment</a>&nbsp;&nbsp;
                    </div>
                    </div>
                </div>
       ...
       var dataTable;
            function initialiseData(){
                dataTable = $('#getStates').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?php echo base_url('master/doctorpanelList'); ?>",  
                        type:"POST",
...
initialiseData();
        ...
        function changestatus(st, id) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "master/doctorsview_status",
                    data: {
                        items: id,
                        status: st
                    },
