            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Size</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/size_edit'; ?>" class="form-horizontal form-material" id="brand-validate" method="post">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">Size<font style="color: red;">*</font></label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-actions" style="text-align:center;">
                                                                <a href="<?php echo base_url() . 'master/size'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save Changes</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/size_save'; ?>" class="form-horizontal form-material" id="brand-validate" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <table class="table table-bordered ">
                                                            ...
                                                            <tbody id="p">
                                                                ...
                                                                <tr>
                                                                    <td width="100">Order No<font style="color: red;">*</font>
                                                                    </td>
                                                                    <td>Size<font style="color: red;">*</font>
                                                                    </td>
                                                                    <td width="200" class="text-center"><span id="newr" onClick="addmore();" class="btn btn-info"><i class="fas fa-plus"></i></span></td>
                                                                </tr>
                                                    ...
                                                    <div class="form-actions no-margin-bottom" style="text-align:center;">
                                                        <a href="<?php echo base_url() . 'master/size'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save</button>
                                                    </div>
