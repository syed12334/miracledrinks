            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Terms & Conditions</h3>
                                ...
                                <?php if ($type == 'edit') : ?>
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            $ser = "error";
                                            if (is_array($info)) {
                                                $ser = $info[0]->conditions;
                                            }
                                            //                                 
                                            ?>
                                            <?php echo $this->session->flashdata('message'); ?>
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'footer/conditions_save'; ?>" class="form-horizontal form-material row" id="form" method="post" enctype="multipart/form-data">


                                                    <div class="form-group col-md-12">
                                                            <textarea id="privacy" name="privacy" required title="Enter Terms & Conditions" class="form-control mymce"><?php echo $ser; ?></textarea>
