										...
										<form action="<?php echo base_url() . 'master/products_edit'; ?>" class="form-horizontal form-material row" id="organization_validate" method="post" enctype="multipart/form-data">
											<div id="accordion" class="col-lg-12">
												<div class="card col-lg-12">
													...
													<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion" id="0">
														<div class="card-body">
															<div class="row">
																...
																<div class="col-6">
																	<div class="form-group">
															<label class="control-label">Difference Noted
															</label>
															<textarea class="form-control" id="differencenoted" name="differencenoted"><?= $details[0]->differencenoted;?></textarea>
														</div>
																	<div class="form-group">
													...
													<div class="col-6">
														<div class="form-group">
															<label class="control-label">Testimonials
															</label>
															<textarea class="form-control" id="testimonials" name="testimonials"><?= $details[0]->testimonials;?></textarea>
														</div>
														<div class="form-group">
...
<table class="table table-bordered ">
																					...
																					<tbody id="i">
																						<?php $prod_images = $this->master_db->getRecords('product_images', ['pid'=>$details[0]->id],'*'); ?>
																	...
																	<div class="form-group col-lg-12">
																		<table class="table table-bordered ">
																			<thead>
																				...
																				<th>Quantity Used</th>
																				<th><span id="newr" onClick="addmorespec();" class="btn btn-info"><i class="fas fa-plus"></i></span></th>
																			</thead>
																			<tbody id="sp">
																				...
																				<?php if (is_array($prod_spec)) {
																					...
																					foreach ($prod_spec as $p) {
																						...
																						$g = $g + 1;
																				?>
																				<input type="hidden" name="spec_id[]" value="<?= $p->id?>">
																						<tr id="r_<?= $p->id?>">
																							<td><input type="text" name="spec_name[]" id="spec_name" class="form-control" placeholder="Enter Ingradients" value="<?php echo $p->spec_name; ?>" />
																							</td>
																							<td><input type="text" name="spec_val[]" id="spec_val" class="form-control" placeholder="Enter Botanical Name" value="<?php echo $p->spec_val; ?>" />
																							</td>
																							<td><input type="text" name="qnts[]" id="qnts" class="form-control" placeholder="Enter Quantity Used" value="<?php echo $p->quantity; ?>" />
																							</td>
																							
																								<td class="text-center"><span class="btn btn-primary" onclick='remove123("<?= $p->id?>")'><i class='fas fa-minus'></i></span>
																								</td>
																					...
																					<tr>
																						...
																						<td><input type="text" name="spec_name[]" id="spec_name" class="form-control" placeholder="Enter Ingradients" value="" /></td>
																						<td><input type="text" name="spec_val[]" id="spec_val" class="form-control" placeholder="Enter Botanical Name" value="" /></td>
																						<td><input type="text" name="qnts[]" id="spec_val" class="form-control" placeholder="Enter Quantity Used" value="" /></td>
																						<!-- <td class="mininwidth text-center">
												...
												<div class="row">
													...
													<div class="col-6">
														...
														<div class="col-6">
															...
															<textarea class="form-control" id="differencenoted" name="differencenoted"></textarea>
														</div>
														<div class="form-group">
															<label class="control-label">Meta Description
															</label>
...
<script src="<?php echo asset_url(); ?>libs/tinymce/tinymce.min.js"></script>
	...
	<script>
        ...
        $(function() {
            if ($("#differencenoted").length > 0) {
                tinymce.init({
                    selector: "textarea#differencenoted",
                    theme: "modern",
                    height: 300,
                    plugins: [
                        "advlist autolink link image lists charmap print preview hr anchor pagebreak spellchecker",
...
function removeimg(id) {
	...
	$.ajax({
		...
		function remove123(trid) {
			...
			$.ajax({
				url :"<?= base_url().'master/removeSpecification';?>",
				method :"post",
				data:{
					id:trid
				},
		...
		function addmorespec() {
			var x = Math.floor((Math.random() * 10000) + 1);
			var row = "<tr id='r_" + x + "'>";
			row +="<input type='hidden' name='spec_id[]' value='' />";
			row +="<td><input type='text' name='spec_name[]' id='spec_name' class='form-control' placeholder='Enter Ingradients' value='' /></td>";
