            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Release Order</h3>
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
                         <div class="d-flex mt-2 justify-content-end">
                            <a href="<?= base_url() ?>master/releaseorder_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD Order</a>
                    </div>
                    </div>
                </div>
                            ...
                            <div class="inner" style="min-height:1200px;">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card-body">
                                             <table id="getPincodes" class="table" style="width:100%">
    <thead>
      <tr>
        <th>Sl No</th>
    ...
    <script type="text/javascript">
       ...
       var dataTable;
            function initialiseData(){
                dataTable = $('#getPincodes').DataTable({  
                    "processing":true,  
                    "serverSide":true,  
                    "searching": true,
                    "order":[],  
                    "ajax":{  
                        url:"<?php echo base_url('master/releaseorder_list/'); ?>",  
                        type:"POST",
...
initialiseData();
        ...
        function changestatus(st, id) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "master/pincode_status",
                    data: {
                        items: id,
                        status: st
                    },
        ...
        function edit(id) {
            var base_url = '<?php echo base_url(); ?>';
            document.location.href = base_url + "master/material_edit?id=" + id;
        }
    </script>
</body>
<!-- END BODY-->
