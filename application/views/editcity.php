...
<body class="padTop53 ">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Cities</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'others/city_edit'; ?>" class="form-horizontal form-material row" id="brand-validate" method="post">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label class="control-label">States<font style="color: red;">*</font></label>
                                                        <select name="state" class="form-control" id="state" required>
                                                            <option value="">--Select--</option>
                                                            <?php
                                                            $st = $this->master_db->getcontent2('states', '', "", '');
                                                            if (is_array($st)) {
                                                                foreach ($st as $d) {
                                                            ?>
                                                                    <option value="<?php echo $d->id ?>" <?php if ($details[0]->state_id == $d->id) { ?>selected="selected" <?php } ?>><?php echo $d->name ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-actions no-margin-bottom col-md-12" style="text-align:center;">
                                                        <a href="<?php echo base_url() . 'others/city'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save Changes</button>
                                                    </div>
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'others/city_save'; ?>" class="form-horizontal form-material row" id="brand-validate" method="post">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label class="control-label">Order<font style="color: red;">*</font></label>
                                                        <input type="text" id="order" name="order" class="form-control onlynumbers" placeholder="" required="required" />
                                                    </div>
                                                        ...
                                                        <table class="table table-bordered ">
                                                            ...
                                                            <tbody id="p">
                                                                <tr>
                                                                    ...
                                                                    <td class="mininwidth"><span id="newr" onClick="addmore();" class="btn btn-info"><i class="fas fa-plus"></i></span></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                    ...
                                                    <div class="form-actions no-margin-bottom  col-md-12" style="text-align:center;">
                                                        <a href="<?php echo base_url() . 'others/city'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save</button>
                                                    </div>
    ...
    <script>
        ...
        function addmore() {
            ...
            var row = "<tr id='r_" + x + "'><td><input type='text' name='np[]' class='form-control' required placeholder=''/></td><td><span class='btn btn-primary' onclick='remove123(" + x + ")'><i class='fas fa-minus'></i></span></td></tr>";
            $('#p').append(row);
        }
        ...
        function getstates(id) {
            $.post('<?php echo base_url(); ?>others/getstate', {
                cid: id
            }, function(data) {
