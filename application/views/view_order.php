				...
				<div class="container-fluid" id="content">
					...
					<div class="inner" style="min-height:700px;">
						...
						$arry_chngstatus = array(
							"",
							"<button class='btn btn-info btn-grad' onclick='changestatus(3," . $id . ")'><i class='fas fa-truck'></i> Change to Shipping </button>",
							"<button class='btn btn-info btn-grad' onclick='changestatus(3," . $id . ")'><i class='fas fa-truck'></i> Change to Shipping </button>",
							"<button class='btn btn-info btn-grad' onclick='changestatus(4," . $id . ")'><i class='mdi mdi-check '></i> Change to Delivered </button>", ""
						);

						if ($status == '-1') {
							$chng = "";
						} else {
							$chng = $arry_chngstatus[$status];
						}

						?>
						<div class="form-actions no-margin-bottom" style="text-align:center;">
							<a href="<?php echo base_url() . 'reports/user_orders'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left"></i> Back</a>&nbsp;
							<?php echo $chng; ?>
						</div>
