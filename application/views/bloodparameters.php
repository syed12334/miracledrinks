            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Blood Parameters</h3>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Masters</a></li>
                            <li class="breadcrumb-item active">Blood Parameters</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
                         <div class="d-flex mt-2 justify-content-end">
                            <a href="<?= base_url() ?>master/bloodparametersadd" class="btn btn-info"><i class="mdi mdi-plus"></i> Add Blood Parameters</a>&nbsp;&nbsp;
                    </div>
                    </div>
                </div>
       ...
       var dataTable;
            function initialiseData(){
                dataTable = $('#getStates').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?php echo base_url('master/getbloodparameterslist'); ?>",  
                        type:"POST",
...
initialiseData();
        ...
        function changestatus(st, id) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "master/bloodparameters_status",
                    data: {
                        items: id,
                        status: st
                    },
