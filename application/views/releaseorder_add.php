...
<body>
 <?php if($type =='add') {
    ?>
        <form action="<?= base_url().'master/releaseordersave';?>" method="post" enctype="multipart/form-data">
                        ...
                        <tr>
                            <td>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="padding-bottom: 3px;">
                                    <tr>
                                        ...
                                        <td valign="top" width="210px" align="right">
                                            Date:<input type="text" style="border: none; border-bottom:1px solid #000;" name="date"/>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td valign="top" width="210px" align="right">
                                            Place:<input type="text" style="border: none; border-bottom:1px solid #000;" name="place" />
                                        </td>
                                    </tr>
                                </table>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tr>
                                                    <td valign="top" style="padding: 5px; line-height: 18px;">
                                                        <b> FROM</b><br>
                                                        Mr/Ms/Mrs. : <input type="text" style="border: none;" name="name" /><br>
                                                        Designation : <input type="text" style="border: none;" name="designation" /><br>
                                                        Contact No. : <input type="number" style="border: none;" name="cno" /><br>
                                                        Client / Agency : <input type="text" style="border: none;" name="client" /><br>
                                                        GST No. : <input type="text" style="border: none;" name="gstno" /><br>
                                                        Address : <input type="text" style="border: none;" name="addr" /><br>

                                                        Email : <input type="text" style="border: none;" name="email" /><br>
                                                        Website : <input type="text" style="border: none;" name="web" /><br>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style=" padding: 5px">
                                    ...
                                    <tr>
                                        <td>M : <input type="text" style="border: none;" name="m"/></td>
                                        <td align="center">Booked By : <input type="text" style="border: none;" name="bookedby" /></td>
                                        <td align="right">R.O No; KTPLATV <input type="text" style="width: 100px; border:none; border-bottom:1px solid #000;" name="rono">/2022-23</td>
                                    </tr>
                                </table>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0" style="  border-right:1px solid #000; border-bottom:1px solid #000; font-size: 11px;">
                                                <tr>
                                                    ...
                                                    <td style="padding:0 5px; border-left: 1px solid #000; border-top: 1px solid #000;">
                                                        <input type="text" style="border: none; width: 100%;" name="adcap" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding:0 5px; border-left: 1px solid #000; border-top: 1px solid #000;">
                                                        <input type="text" style="border: none; width: 100%;" name="dur" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px 5px; border-left: 1px solid #000; border-top: 1px solid #000;">
                                                    ...
                                                    <td style="padding:0 5px; border-left: 1px solid #000; border-top: 1px solid #000;">
                                                        <input type="text" style="border: none; width: 100%;" name="noofinsertion" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding:0 5px; border-left: 1px solid #000; border-top: 1px solid #000;">
                                                        <input type="text" style="border: none; width: 100%;" name="totalfct" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding:0 5px; border-left: 1px solid #000; border-top: 1px solid #000;">
                                                        <input type="text" style="border: none; width: 100%;" name="er" />
                                                    </td>
                                                </tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0" style=" padding: 5px; border-right:1px solid #000; border-top:1px solid #000; border-bottom:1px solid #000; font-size: 11px;">
                                                ...
                                                <tr>
                                                    <td align="right" style="padding-bottom:1px;">
                                                        L Band <input type="checkbox" style="width:30px ; height:30px; border: 1px solid #000; vertical-align: middle;" value="1" name="lband" />
                                                    </td>
                                                    <td align="right" style="padding-bottom:1px;">
                                                        Aston Band <input type="checkbox" style="width:30px ; height:30px; border: 1px solid #000; vertical-align: middle;" value="1" name="astonband" />
                                                    </td>
                                                    <td align="right" style="padding-bottom:1px;">
                                                        Spot ROS <input type="checkbox" style="width:30px ; height:20px; border: 1px solid #000; vertical-align: middle;" value="1" name="spotros" /><br>
                                                        Spot RODP <input type="checkbox" style="width:30px ; height:20px; border: 1px solid #000; vertical-align: middle;" value="1" name="spotrodp" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" style="padding-bottom:1px;">
                                                        Scroll <input type="checkbox" style="width:30px ; height:30px; border: 1px solid #000; vertical-align: middle;" value="1" name="scroll" />
                                                    </td>
                                                    <td align="right" style="padding-bottom:1px;">
                                                        Slot <input type="checkbox" style="width:30px ; height:30px; border: 1px solid #000; vertical-align: middle;" value="1" name="slot" />
                                                    </td>
                                                    <td align="right" style="padding-bottom:1px;">
                                                        Others <input type="checkbox" style="width:30px ; height:30px; border: 1px solid #000; vertical-align: middle;" value="1" name="others" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-left: 1px solid #000; border-bottom:1px solid #000; font-size: 11px;">
                                    <tr>
                                        ...
                                        <td style="padding: 5px; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                                            <div style="display:inline-block; "> FROM <input type="text" style="border:none;border-bottom: 1px solid #000; height:15px; width: 70px; " name="from">
                                            </div>
                                            <div style="display:inline-block; "> TO <input type="text" style="border:none;border-bottom: 1px solid #000; height:15px; width: 70px; " name="to">
                                            </div>
                                            <div style="display:inline-block; "> Total No. of Days <input type="text" style="border:none;border-bottom: 1px solid #000; height:15px; width: 70px; " name="tofdays">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border-right: 1px solid #000; border-bottom: 1px solid #000;"> TOTAL
                                            FCT</td>
                                        <td style="padding:0 5px; border-right: 1px solid #000; border-bottom: 1px solid #000;"><input type="text" style="border: none; width: 100%;" name="total" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:1px 10px; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                                            <div style="display:inline-block; width: 30%;"> ROS <input type="checkbox" style="border: 1px solid #000; height:20px; width: 50px; vertical-align: middle;" name="ros" value="1"> </div>
                                            <div style="display:inline-block; width: 30%;"> RODP <input type="checkbox" style="border: 1px solid #000; height:20px; width: 50px; vertical-align: middle;" name="rodp" value="1"> </div>
                                            <div style="display:inline-block; width: 30%;"> Prog. Specific <input type="checkbox" style="border: 1px solid #000; height:20px; width: 50px; vertical-align: middle;" name="prog" value="1"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border-right: 1px solid #000; ">RODP TIMINGS</td>
                                        <td style="padding:0 5px; border-right: 1px solid #000; "><input type="text" style="border: none; width: 100%;" name="rodptimings" /></td>
                                    </tr>
                                </table>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="">
                                    ...
                                    <tr>
                                        <td style="padding:5px 10px ;">By Hand <input type="checkbox" style="border: 1px solid #000; height:20px; width: 30px; vertical-align: middle;" name="byhand" value="1"> </td>
                                        <td style="padding:5px 10px ;">By E-mail <input type="checkbox" style="border: 1px solid #000; height:20px; width: 30px; vertical-align: middle;" name="byemail" value="1"> </td>
                                        <td style="padding:5px 10px ;">Photo/E-brochures <input type="checkbox" style="border: 1px solid #000; height:20px; width: 30px; vertical-align: middle;" name="photoe" value="1"> </td>
                                        <td style="padding:5px 10px ;">As Enclosed <input type="checkbox" style="border: 1px solid #000; height:20px; width: 30px; vertical-align: middle;" name="asenclosed" value="1"> </td>
                                    </tr>
                                    <tr>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="padding: 5px 10px 0 10px;">
                                    ...
                                    <tr>
                                        <td style="border-bottom:1px solid #000 ; padding: 0px 0;"><input type="text" style="border: none; width: 100%;" name="specialins" /> </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="border-bottom:1px solid #000 ; padding: 0px 0;"> <input type="text" style="border: none; width: 100%;" name="valueadded" /> </td>
                                    </tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0" style="font-size: 10px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding:0 5px;">
                                                        <input type="text" style="border: none; width: 100%;" name="billmount" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;">
                                                        GST</td>
                                                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding:0 5px;">
                                                        <input type="text" style="border: none; width: 100%;" name="gst" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;">
                                                    ...
                                                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding:0 5px;">
                                                        <input type="text" style="border: none; width: 100%;" name="deduction" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;">
                                                        TOTAL TO PAY</td>
                                                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding:0 5px;">
                                                        <input type="text" style="border: none; width: 100%;" name="totalpay" />
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0" style="font-size: 10px;">
                                                ...
                                                <tr>
                                                    <td style="width:50%; border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;">
                                                        CHQ</td>
                                                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding:0 5px;">
                                                        <input type="text" style="border: none; width: 100%;" name="chq" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;">
                                                        CASH</td>
                                                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding:0 5px;">
                                                        <input type="text" style="border: none; width: 100%;" name="cash" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;">
                                                        NEFT</td>
                                                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding:0 5px;">
                                                        <input type="text" style="border: none; width: 100%;" name="neft" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;">
                                                        UPI</td>
                                                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding:0 5px;">
                                                        <input type="text" style="border: none; width: 100%;" name="upi" />
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="">
                                    <tr>
                                        <td style="padding: 5px 10px;">
                                            (Rupees <input type="text" style="width: 91%; border:none; border-bottom:1px dashed #000;" name="rupees" /> )
                                        </td>
                                    </tr>
                                </table>
...
<div class="file-upload">
  ...
  <span class="file-upload__label"></span>
                                        ...
                                        (Client's Signature with Seal)</td>
                                    </tr>
                                </table>
    ...
    ?>
    <form action="<?= base_url().'master/releaseordersave';?>" method="post" >
    <div class="container-fluid marketing">
