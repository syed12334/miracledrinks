<table id="alt_pagination" class="table table-striped table-bordered display" style="width:100%">
    ...
    <tbody>
        ...
        <?php
        $testimonials = $this->home_db->getRecords('testimonials', array("status !=" => 2), '*', 'id DESC');
        if (count($testimonials) > 0) {
            $i = 1;
            foreach ($testimonials as $b) {
                $cls = "";
				...
				$image="<img src='".front_url()."".$b->image_path."' width='100' width='100'>";
        ?>
                <tr>
                    <td><?php echo $i; ?></td>
