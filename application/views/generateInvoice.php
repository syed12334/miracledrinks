<?php 
		...
		$data.='<div id="cart-tab" class="tab selected" style="width: 100%;">Generate Invoice ';
		...
		if($row[0]->status != "-1"){//build
			...
			$data.='<td><input type="date" name="invoice_date" value='.$today.' id="invoice_date"  class="form-control datepicker" style="width:50%;"></td>';
			$data.='</tr>';
		}
		...
		$data.='<td><button onclick="submit_invoice('.$id.');" type="button" class="btn btn-primary btn-xs"> Generate Invoice</button>
