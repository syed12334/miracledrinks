...
<body class="padTop53 ">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
						 <div class="d-flex mt-2 justify-content-end">
							<a href="<?= base_url() ?>master/color_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD Color</a>
                    </div>
                    </div>
                </div>
	...
	$(function () {
     ...
     /*   $(document).ready(function() {
            ...
            $("#flex1").flexigrid({
                url: base_url + 'master/color_table',
                dataType: 'json',
                colModel: [{
                        display: 'Sl No.',
                        width: 70,
        ...
        function test(com, grid) {
            if (com == 'Add') {
                var base_url = '<?php echo base_url(); ?>';
                document.location.href = base_url + "master/color_add";
            } else if (com == 'Refresh') {
                sortAlpha("");
            }
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "master/color_status",
                    data: {
                        items: id,
                        status: st
                    },
        ...
        function edit(id) {
            var base_url = '<?php echo base_url(); ?>';
            document.location.href = base_url + "master/color_edit?id=" + id;
        }
    </script>
</body>
<!-- END BODY-->
