            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Sub Category</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/subcategory_edit'; ?>" class="form-horizontal form-material" enctype="multipart/form-data" id="brand-validate" method="post">
                                                    ...
                                                    <div class="col-md-6">
                                                             ...
                                                             <label class="control-label">Category<font style="color: red;">*</font></label>
																...
																<select name="country" class="form-control" id="country"  required >
																	...
																	<?php if(is_array($country)){
																		...
																		?>
																			<option value="<?php echo $d->id?>" <?php if($details[0]->category_id == $d->id){?>selected="selected"<?php }?> ><?php echo $d->name?></option>
																	<?php }}?>
																</select>
                                                        ...
                                                        <div class="col-md-6">
                                                        <div class="form-group">
                                                           <label class="control-label ">Sub Category<font style="color: red;">*</font></label>
                                                        ...
                                                        <div class="form-actions" style="text-align:center;">
                                                            ...
                                                            <a href="<?php echo base_url() . 'master/subcategory'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save Changes</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </form>
                                ...
                                <?php } else { ?>
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/subcategory_save'; ?>" class="form-horizontal form-material" enctype="multipart/form-data" id="brand-validate" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label">Order No.<font style="color: red;">*</font></label>
                                                            ...
                                                            <input type="text" id="order_no" name="order_no" maxlength="3" required class="form-control onlynumbers" value="1" />
                                                        </div>
                                                ...
                                                <input type="text" id="np[]" name="np[]" required class="form-control" value=""/>
                                            </div>
                                                    </div>
