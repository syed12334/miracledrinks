                ...
                <div class="container-fluid" id="content">
                    <div class="inner" style="min-height:1200px;">
                        ...
                        <div class="card card-body">
                            <h3 class="mb-0">Import States</h3>
                            <hr>
                           <form action="<?php echo base_url()?>master/ImportStates" id="body_validate" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="$('#show_wait').show(); return true;">
                            <div class="control-group col-lg-5">
								<label class="control-label" for="focusedInput">Select Excel File<font color="#FF0000">*</font></label>
								<div class="controls">
									<input class="input-file uniform_on" id="pinfile" required="required"  name="excel_data" type="file" onchange="readURL(this)" accept=".xls,.xlsx">
									<input type="hidden" name="chnglogo" id="chnglogo" value="0"  />
                                    <br><br>
									<p class="help-block alert-info p-2"><b>Note: Upload only .xls,.xlsx file.</b></p><br>
									<span for="pinfile" style="margin-left: 42%; color:red;" class="help-block"></span>
							...
							<div class="form-actions no-margin-bottom" style="text-align:center;">
								<button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Import</button> <button onclick="location.href='<?php echo base_url()?>master/states'" class="btn btn-danger" type="button"><i class="fa fa-close"></i> Cancel</button> 
								<button onclick="location.href='<?php echo base_url()?>assets/state.png'" class="btn btn-success" type="button"><i class="fa fa-file-excel-o"></i> View/Download Excel Format</button>
							</div>
							<?php echo $this->session->flashdata('message');?>
							<div style="display: none;" id="show_wait" class="alert alert-warning alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please wait...</div>
							</form>
                        </div>
                    </div>
                        </div>
