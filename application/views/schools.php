...
<body class="padTop53 ">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">School Details</h3>
                     ...
                     <div class="col-md-7 col-12 align-self-center d-none d-md-block">
                        <div class="d-flex mt-2 justify-content-end">
                            <a href="<?= base_url() ?>master/schoolsdetailsview" class="btn btn-info" style="margin-right:10px"><i class="far fa-file-excel"></i> Export to excel</a>
       ...
       /* $(document).ready(function() {
		...
		$(function () {
			...
			function viewGallery(id) {
               $.ajax({
                    url :"<?= base_url().'master/viewgallery'; ?>",
                    method :"post",
                    dataType:"json",
                    data : {
                        id :id
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog modal-lg" style="max-width: 550px!important;">
