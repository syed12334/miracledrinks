            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Pincodes</h3>
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
						 <div class="d-flex mt-2 justify-content-end">
							<a href="<?= base_url() ?>master/pincode_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD Pincode</a>
                    </div>
                    </div>
                </div>
       ...
       var dataTable;
            function initialiseData(){
                dataTable = $('#getPincodes').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?php echo base_url('master/getPincodeList/'); ?>",  
                        type:"POST",
