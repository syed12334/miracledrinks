                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
						 <div class="d-flex mt-2 justify-content-end">
							<a href="<?= base_url() ?>master/material_add" class="btn btn-info"><i class="mdi mdi-plus"></i> ADD Material</a>
                    </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
	 ...
	 $(function () {
        ...
        /*$(document).ready(function() {
            ...
            $("#flex1").flexigrid({
                url: base_url + 'master/material_table',
                dataType: 'json',
                colModel: [{
                        display: 'Sl No.',
                        width: 70,
		...
		function changestatus(st, id) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    type: "POST",
                    url: base_url + "master/material_status",
                    data: {
                        items: id,
                        status: st
                    },
