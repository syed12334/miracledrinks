                                ...
                                <?php if ($type == 'edit') : ?>
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            $ser = "error";
                                            if (is_array($info)) {
                                                $ser = $info[0]->customerservice;
                                            }
                                            //                                 
                                            ?>
                                            <?php echo $this->session->flashdata('message'); ?>
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'footer/customerservice_save'; ?>" class="form-horizontal form-material row" id="form" method="post" enctype="multipart/form-data">
