            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Disease Add</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/disease_edit'; ?>" class="form-horizontal form-material" enctype="multipart/form-data" id="brand-validate" method="post">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-actions" style="text-align:center;">
                                                            ...
                                                            <a href="<?php echo base_url() . 'master/disease'; ?>" class="btn btn-primary"><i class="mdi mdi-arrow-left "></i> Back</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-info"><i class="mdi mdi-check "></i> Save Changes</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </form>
                                ...
                                <?php } else { ?>
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="card-body">
                                                <form action="<?php echo base_url() . 'master/disease_save'; ?>" class="form-horizontal form-material" method="post">
