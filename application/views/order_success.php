                                 ...
                                 <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="100%">
                                    <tr>
                                       <td align="center" valign="middle" width="100%">
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" class="fullCenter" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="100%">
                                             <tr>
                                                <td style="font-size:16px; color:#000000; padding:0 15px; text-align: left; font-family:'Lato',Arial, sans-serif; font-weight:400; line-height:26px;" width="50%">Order Id : <?php echo $order[0]->orderid;?></td>
                                                <td style="font-size:16px; color:#000000; padding:0 15px; text-align: right; font-family:'Lato',Arial, sans-serif; font-weight:400; line-height:26px;" width="50%">Placed On : <?php $date=date_create($order[0]->ordered_date);echo date_format($date,"d-m-Y");?></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                                 ...
                                 <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="570">
                                   ...
                                   <?php if(is_array($order_products)){
                                       ...
                                       <td align="center" bgcolor="#FAFAFA" class="em_pad" valign="top">
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="500">
                                             <tr>
                                                ...
                                                <?php echo $ord->size_name;?></td>
                                                <td align="left" style="font-size:13px; color:#36628b; font-family:'Lato',Arial, sans-serif; font-weight:400;" width="25%">Price<br>
                                                <span style="font-size:15px; color:#000; font-family:'Lato',Arial, sans-serif; font-weight:700;">Rs.<?php echo $this->home_db->getnumberformat($ord->price);?></span></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                                    ...
                                    <tr>
                                     ...
                                     <?php
                                if(!empty($order[0]->taxamount) && $order[0]->taxamount !=0) {
                                    ?>
                                    <tr>
                                       <td align="center" bgcolor="#FAFAFA" class="em_pad" valign="top">
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" width="500">
                                             <tr>
                                                <td align="left" colspan="3" style="font-size:13px; text-align: right; color:#36628b; font-family:'Lato',Arial, sans-serif; font-weight:400;" width="25%">Tax <span style="font-size:15px; color:#000; font-family:'Lato',Arial, sans-serif; font-weight:700;">Rs.<?php echo number_format($order[0]->taxamount);?></span></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
